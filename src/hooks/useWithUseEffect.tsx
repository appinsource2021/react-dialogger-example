...
const DialogBody = ({dialog}: {dialog: IDialogApiDef}) => {
    const useWithSlotHook = useWithSlot();
    return <div>
        <table>
            <thead>
            <tr>
    ...
    const openDialog = () => {
        ...
        dialog
            .setHeader( (dialog: IDialogApiDef ) => <div>
                <span>Using useEffect instead of show for load events with Memo</span>
            </div> )
